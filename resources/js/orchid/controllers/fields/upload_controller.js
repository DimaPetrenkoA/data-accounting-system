...
export default class extends Controller {
    ...
    initDropZone() {
        ...
        this.dropZone = new Dropzone(dropname, {
            ...
            init: function () {
                this.on('addedfile', (e) => {
                    ...
                    if (this.files.length > this.options.maxFiles) {
                        window.platform.alert('Ошибка проверки', 'Макс. файлов');
                        this.removeFile(e);
                    }
                ...
                this.on("maxfilesexceeded", (file) => {
                    window.platform.alert('Ошибка проверки', 'Превышено максимальное количество файлов');
            ...
            error(file, response) {
                window.platform.alert('Ошибка проверки', 'File upload error');
