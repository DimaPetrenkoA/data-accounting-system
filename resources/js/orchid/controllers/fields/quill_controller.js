...
export default class extends Controller {
    ...
    selectLocalImage() {
        ...
        input.onchange = () => {
            ...
            if (/^image\//.test(file.type)) {
                ...
                window.platform.alert('Ошибка проверки', 'Вы можете загружать только изображения.', 'опасно');
    ...
    saveToServer(file) {
        ...
        axios
            ...
            .catch((error) => {
                window.platform.alert('Ошибка проверки', 'Не удалось загрузить изображение');
