...
return [
    ...
    */
    ...
    'exists'               => 'В таблице не существует записи :attribute со значением :value.',
    ...
    'in'                   => 'Поле :attribute не принимает одно из установленных значений: (:values)',
    ...
    'numeric'              => 'Поле :attribute должно быть числом без пробелов и точкой в качестве разделителя.',
    'password'             => 'Неверный пароль.',
    'present'              => 'Поле :attribute должно присутствовать.',
    'regex'                => 'Поле :attribute имеет ошибочный формат.',
    'required'             => 'Поле :attribute обязательно для заполнения.',
    'required_if'          => 'Поле :attribute обязательно для заполнения, когда :other равно :value.',
    'required_if_like'          => 'Поле :attribute обязательно для заполнения, когда :other равно :value.',
    ...
    'empty'                => 'Поле :attribute должно быть пустым.',
    'empty_if_like'        => 'Поле :attribute должно быть пустым, когда :other равно :value.',
    'empty_with'           => 'Поле :attribute должно быть пустым, когда :values указано.',
    'empty_without'        => 'Поле :attribute должно быть пустым, когда :values не указано.',
    'one_of'        => 'Допустимо заполнение только одного из следующих полей: :attribute, :values',
