...
return [
    ...
    */
    ...
    |
    */
    /* public - то что видно не авторизованным пользователям (всем),
    private - то что видно только авторизованным пользователям.
    Можно добавить сколько угодно новых промежуточных слоёв, например,
    слой фильтрации запросов только из белого списка IP адресов. */
    ...
    |
    */
    /* Существует возможность и вовсе отключить поставляемую форму авторизации и сделать собственную,
    например с помощью пакета Jetstream. */
    'auth'  => true,
    ...
    |
    */
// Главная страница приложения записана в виде названия маршрута,
// именно её увидит пользователь при входе или нажатии на логотипы и ссылки.
    'index' => 'platform.main',
    ...
    */
    ...
    'icons' => [ 'fa' => public_path('fontawesome') ],
