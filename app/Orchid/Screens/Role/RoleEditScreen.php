...
class RoleEditScreen extends Screen
{
     ...
     * @var string
     */
    public $description = 'Настроить права для роли';
    ...
    public function commandBar(): array
    {
        return [
            ...
            Button::make(__('Remove'))
                ->icon('trash')
                ->method('remove')
                ->confirm('Вы действительно хотите удалить роль? Восстановить роль будет невозможно!')
                ->canSee($this->exist),
        ];
    }
